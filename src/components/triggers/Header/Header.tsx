...
export const Header = () => {
  ...
  return (
    <>
      <header className='h-24 flex justify-end items-center p-5 fixed w-screen z-50 bg-white md:static md:flex-col md:justify-center md:h-auto md:p-8'>
        <Image className='w-14 absolute left-0 right-0 top-0 bottom-0 m-auto md:static md:w-20 lg:w-28' src='/logo/Logo_Budde-full.webp' alt='' width={400} height={425} />
