...
export const FirstView = () => {
  return (
    <Section innerClass='md:flex md:flex-row-reverse md:gap-14 md:pt-10 md:items-center lg:gap-24 2xl:pt-20'>
      <>
        <Image className='rounded-md shadow-md object-cover md:w-6/12' src='/images/Image_About-fv.webp' alt='' width={842} height={596} />
