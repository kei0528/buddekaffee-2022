...
import { fetchMessages, fetchStatus, validateMessages } from 'src/utils/status';
      ...
      html: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
            ...
            <head>
              ...
              <style type="text/css">
                ...
                .main { width:80%; padding: 30px; background-color:#fff;margin: auto; margin-top: 50px; text-align:center; }
                h1 { color:#383131; }
